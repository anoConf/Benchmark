...
public class CyclicGRDBenchDataSet implements BenchDataSet {
	private static final String NAME = "CircleBench";
	
	private int[] sizes;
	private int nbrAtoms, nbrTerms;
	
	public CyclicGRDBenchDataSet(int[] sizes, int nbrAtoms, int nbrTerms) {
		this.sizes = sizes;
		this.nbrAtoms = nbrAtoms;
		this.nbrTerms = nbrTerms;
	}
	
	public CyclicGRDBenchDataSet(int[] sizes) {
		this(sizes, 1, 1);
	}
